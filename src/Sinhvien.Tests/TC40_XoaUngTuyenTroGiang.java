...
import TroGiang.Page.DashBoardPage_XoaUngTuyenTroGiang;
import TroGiang.Page.LoginPage;

public class TC40_XoaUngTuyenTroGiang {
	 private WebDriver driver;
	    private LoginPage loginPage;
	    private DashBoardPage_XoaUngTuyenTroGiang dashBoardPage;
	    ...
	    public void setUp() {
	        ...
	        dashBoardPage = new DashBoardPage_XoaUngTuyenTroGiang(driver);
	    }

	    @Test(priority = 1, description = "Kiểm thử xem kết quả xóa đăng ký Trợ giảng")
	    public void testXemUngTuyenTroGiang() {
	        try {
	            ...
	            dashBoardPage.HuyDangKy();
	            System.out.println("✅ Đã hủy thông tin đăng ký.");
	            
	            dashBoardPage.submitBTN();
	            System.out.println("✅ Đã xác nhận thông tin đăng ký.");
