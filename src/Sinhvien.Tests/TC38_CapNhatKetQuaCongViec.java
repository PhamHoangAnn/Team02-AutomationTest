...
import TroGiang.Page.DashBoardPage_CapNhatKetQuaCongVIec;
import TroGiang.Page.LoginPage;

public class TC38_CapNhatKetQuaCongViec {
    private WebDriver driver;
    private LoginPage loginPage;
    private DashBoardPage_CapNhatKetQuaCongVIec dashBoardPage;
    ...
    public void setUp() {
        ...
        dashBoardPage = new DashBoardPage_CapNhatKetQuaCongVIec(driver);
    }
    ...
    public void testXemTienDoCongViec() {
        try {
            ...
            dashBoardPage.navigateToTaskList();
            System.out.println("Đã cập nhật lại trang Công Việc.");
            Thread.sleep(3000);
